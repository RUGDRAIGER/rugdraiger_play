    ...
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{ padding: '20px 28px 16px', flexShrink: 0 }}>
          <button onClick={() => setSelected(null)} style={{ color: 'var(--text-secondary)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4, fontSize: 14, marginBottom: 16 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div>
              ...
              <button
                ...
                style={{ marginTop: 10, padding: '8px 16px', borderRadius: 'var(--radius-md)', background: 'var(--accent)', color: '#fff', fontSize: 13, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}
              >
        ...
        <div className="scrollable" style={{ flex: 1, padding: '0 28px' }} onClick={() => setMenuState(null)}>
          {artistSongs.map((song) => (
            <div
              key={song.id}
              onDoubleClick={() => playSong(song, artistSongs)}
